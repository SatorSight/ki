...
class Image150OptimizeCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        //todo make adminka

        $this->setName('dev:images-optimize-150')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($journals as $j){
            ...
            if(is_file($path.$image)) {
                ...
                $image_final_name = $path . str_replace($image_name, '150_' . $image_name, $image);
